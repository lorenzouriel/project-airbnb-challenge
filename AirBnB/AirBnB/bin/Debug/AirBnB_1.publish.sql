...
GO
:setvar DatabaseName "AirBnB"
:setvar DefaultFilePrefix "AirBnB"
...
CREATE TABLE [dbo].[listings] (
    ...
    [host_has_profile_pic]        NVARCHAR (1)   NULL,
    ...
    CONSTRAINT [pk_listing_id] PRIMARY KEY CLUSTERED ([listing_id] ASC)
);
...
CREATE TABLE [dbo].[reviews] (
    ...
    CONSTRAINT [pk_review_id] PRIMARY KEY CLUSTERED ([review_id] ASC)
);


GO
PRINT N'Creating Foreign Key [dbo].[fk_review_listing_id]...';


GO
ALTER TABLE [dbo].[reviews]
    ADD CONSTRAINT [fk_review_listing_id] FOREIGN KEY ([listing_id]) REFERENCES [dbo].[listings] ([listing_id]);
